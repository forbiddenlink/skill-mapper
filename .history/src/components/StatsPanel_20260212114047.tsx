    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-20 right-4 z-50 p-3 bg-gray-900 border border-gray-700 rounded-full hover:border-plasma-pink hover:text-plasma-pink transition-colors text-gray-400 shadow-lg"
                title="View Stats"
