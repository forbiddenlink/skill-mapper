    ...
    return (
        <div className="w-full h-full bg-deep-void">
            <ReactFlow
                ...
                ariaLabelConfig={{
                    'node.a11yDescription.default': 'Press Enter to select this skill, or use arrow keys to navigate',
                    'node.a11yDescription.selected': 'Selected. Press Enter to open details, or use arrow keys to navigate',
                    'edge.a11yDescription': 'Prerequisite connection',
                }}
